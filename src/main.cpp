/******************************************************************************
 * Neopixel star with FastLED
 *
 * A Christmas tree star with 5 8-Neopixel strips.
 *
 * Thanks to [Scott Marley](https://www.youtube.com/channel/UCOoMeR4LgbGExLUCNVf184g)
 * for his great tutorials. Much of this code was written before I started going
 * through his tutorials, but I'll be improving it as I can.
 *
 * Thanks to [Dave Plumber](https://www.youtube.com/channel/UCNzszbnvQeFzObW0ghk0Ckw)
 * for turning us onto Platform.io.
 *
 * Ideas to try:
 * - Make random function picker
 * - Implement the colorPulse and colorPing functions
 * - Fill_gradient
 * - Use the example from FastLED basics 2 to alter saturation for a color?
 * - Palletes and fadeToBlackby???? for a twinkle effect
 * ***************************************************************************/
...
void setup()
{
  FastLED.addLeds<WS2812B, DATA_PIN, GRB>(output, NUM_LEDS);
...
void nextPattern()
{
  ...
  if (useSource1)
    source1Pattern = patternCounter; // Determine which source array for new pattern
  else
